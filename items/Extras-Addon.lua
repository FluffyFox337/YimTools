...
======================Modifications by FluffyFox337=============================================
================================================================================================
Some modifications in v 1.0.9 :

* Money Remover Car repair service (from Silent_Night)
 ( directly set amount to remove dollars GTA )

* Delete message "I have given the entire lobby all weapons."
* Delete message "I have removed all weapons from the entire lobby."

  (I just commented out there lines )

NOTE:
You can find all edits in the code of the file “Extras-Addon.lua” by the word “modded337”.
================================================================================================
...
-- Money Remover Car repair service (from Silent_Night) modded337

moneyRemover2 = Money:add_tab("Money Remover Silent Night")

removerInput = moneyRemover2:add_input_int("Car repair service")

moneyRemover2:add_button("Set Amount", function()
    if removerInput:get_value() <= 0 then
        gui.show_error("Money Remover Silent_Night", "Amount Must Be Greater Than 0")
    else
        globals.set_int(2707037 + 36, removerInput:get_value())
        gui.show_message("Money Remover Silent_Night", "Amount Successfully Set")
    end
end)
...
Global:add_button("Give All Weapons to Players", function()
	script.run_in_fiber(function(giveWeapons)
		...
		--msg = "I have given the entire lobby all weapons.  This only lasts until you switch sessions, enjoy!" modded337
...
Global:add_button("Remove All Weapons from Players", function()
	script.run_in_fiber(function(removeWeapons)
		...
		for i = 0, 31 do
		 ...
		 --msg = "I have removed all weapons from the entire lobby.  This only lasts until you switch sessions, have fun!" modded337
		--network.send_chat_message(msg, false)
