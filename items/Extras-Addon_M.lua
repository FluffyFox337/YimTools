...
NOTE:
You can find all edits in the code of the file “Extras-Addon.lua” by the word “modded”.
================================================================================================
...
-- Money Remover Car repair service (from Silent_Night) MODDED
...
Global:add_button("Give All Weapons to Players", function()
	script.run_in_fiber(function(giveWeapons)
		...
		--msg = "I have given the entire lobby all weapons.  This only lasts until you switch sessions, enjoy!" modded
...
Global:add_button("Remove All Weapons from Players", function()
	script.run_in_fiber(function(removeWeapons)
		...
		for i = 0, 31 do
		 ...
		 --msg = "I have removed all weapons from the entire lobby.  This only lasts until you switch sessions, have fun!" modded
		--network.send_chat_message(msg, false)
